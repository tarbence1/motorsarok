...
! function(e) {
    e.fn.imageUploader = function(t) {
        ...
        let o = function() {
                ...
                n = e("<input>", { type: "file", id: 'image-upload', name: a.settings.imagesInputName + "[]", accept: a.settings.extensions.join(","), multiple: "" }).appendTo(t);
            ...
            l = function(t, i, o) {
                ...
                } else l.attr("data-index", i) && l.attr("id", "image-" + i);
            ...
            g = function(e) { return !(a.settings.extensions.indexOf(e.name.replace(new RegExp("^.*\\."), ".")) < 0) || (alert(`A következő kép: "${e.name}" kiterjesztése nem megfelelő: "${a.settings.extensions.join('", "')}"`), !1) },
            c = function(e) { return !(a.settings.mimes.indexOf(e.type) < 0) || (alert(`A következő kép: "${e.name}" formátuma nem megfelelő, a következő típusú képeket tudjuk elfogadni: "${a.settings.mimes.join('", "')}"`), !1) },
            f = function(e) { return !(e.size > a.settings.maxSize) || (alert(`A következő kép: "${e.name}" meghaladja a  ${a.settings.maxSize/1024/1024}Mb limitet. Kérjük válasszon másik képet.`), !1) },
            m = function(e, t) { return !(e + s.items.length + a.settings.preloaded.length >= a.settings.maxFiles) || (alert(`A következő kép: "${t.name}" nem kerül feltöltésre, mert meghaladja az ${a.settings.maxFiles} kép limitet!`), !1) },
            u = function(t, n) {
