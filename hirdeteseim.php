...
$userid = $_SESSION['id'];
$sql = "SELECT * FROM motorcycles WHERE userid = ? AND status = ?";
$status = 1;
...
<body>
    ...
    <div id="content">
        ...
        <div class="row" id="main-cards-garage">
            ...
            if (empty($data)) {
                echo '<div class="text-center" id="no-advertisement">Önnek még nincs hirdetése a rendszerben. Amennyiben szeretne feladni egyet, <a href="hirdetesfeladas.php" id="ad-here">itt</a> teheti meg.</div>';
            } else {
                    ...
                    <a href="#" data-toggle="modal" data-target="#modal-<?php echo htmlspecialchars($row['id']); ?>">
                        <div class="card" id="motor-cards">
                            ...
                            <div class="card-body">
                                ...
                                <hr>
                                <form action="hirdeteseim.php" method="POST" onsubmit="return confirm('Biztosan törölni szeretné?');">
